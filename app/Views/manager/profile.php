...
<head>
    ...
    <title>الملف الشخصي - المدير</title>
    ...
    <style>
        :root {
            ...
            --gradient-start: #8d0865ff;
            --gradient-end: #4a044eff;
        }
        ...
        .input-field:focus {
            ...
            box-shadow: 0 0 0 3px rgba(141, 8, 101, 0.1);
        }
        ...
        .btn-primary:hover {
            ...
            box-shadow: 0 7px 14px rgba(141, 8, 101, 0.4);
        }
    ...
    <div class="container mx-auto max-w-6xl">
        ...
        <div class="profile-card mb-8">
            <div class="profile-header text-center">
                ...
                <div class="absolute top-4 left-4">
                    <span class="badge bg-white text-purple-700">
                ...
                <div>
                    ...
                    <div class="grid grid-cols-2 gap-4 mb-6">
                        <div class="stats-card text-center">
                            <div class="text-3xl font-bold text-purple-600 mb-2"><?= number_format($averageScores['overall_avg'] ?? 0, 1) ?></div>
                        ...
                        <div class="stats-card text-center">
                            <div class="text-3xl font-bold text-blue-600 mb-2"><?= $averageScores['total_evaluations'] ?? 0 ?></div>
                            <i class="fas fa-clipboard-check text-blue-500 text-2xl mb-2"></i>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div class="profile-card p-6">
                <h2 class="text-xl font-bold text-gray-800 mb-6 flex items-center">
                    <i class="fas fa-info-circle ml-2 text-purple-500"></i>
                    المعلومات الإضافية
                </h2>
                
                <form action="/employee-portal/public/manager/profile/update" method="POST" class="space-y-4">
            ...
            <div class="profile-card p-6">
                <h2 class="text-xl font-bold text-gray-800 mb-6 flex items-center">
                    <i class="fas fa-star ml-2 text-purple-500"></i>
                    التقييمات التفصيلية
                </h2>
