<div class="container mx-auto">
    <h1 class="text-2xl font-bold mb-6">طلب إجازة - الموظف</h1>

    <div class="bg-white p-6 rounded-lg shadow">
        <form action="/employee-portal/public/employee/leave-request" method="POST" id="leaveForm">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                ...
                <div>
                    ...
                    <div class="bg-green-100 p-3 rounded text-center">
                        <span class="text-xl font-bold text-green-600"><?= $employee['leaveBalance'] ?></span>
            ...
            <div class="flex justify-between items-center">
                <a href="/employee-portal/public/employee" 
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function calculateDays() {
        if (startDate.value && endDate.value) {
            ...
            // التحقق من الرصيد
            const availableBalance = <?= $employee['leaveBalance'] ?>;
