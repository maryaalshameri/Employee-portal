...
<head>
    ...
    <title>إضافة موظف جديد - لوحة التحكم</title>
...
<body class="flex h-screen text-gray-800">
    ...
    <main class="flex-1 overflow-auto bg-gray-50">
        ...
        <div class="p-6">
            ...
            <div class="form-container p-6 mb-8">
                <h2 class="text-xl font-bold text-gray-800 mb-6 border-b pb-2">بيانات الموظف الجديد</h2>
                
                <form method="post" action="/employee-portal/public/admin/employees/create" id="employeeForm" class="space-y-6" novalidate>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <input type="text" id="name" name="name" value="<?= isset($_SESSION['old_input']['name']) ? htmlspecialchars($_SESSION['old_input']['name']) : '' ?>" 
                                    class="form-input w-full px-4 py-2 rounded-lg" required
                                    pattern="[\\u0600-\\u06FF\\u0750-\\u077F\\u08A0-\\u08FF\\s]{2,50}" 
                            ...
                            <div>
                                ...
                                <input type="email" id="email" name="email" value="<?= isset($_SESSION['old_input']['email']) ? htmlspecialchars($_SESSION['old_input']['email']) : '' ?>" 
                                    class="form-input w-full px-4 py-2 rounded-lg" required>
                            ...
                            <div>
                                ...
                                <?php endif; ?>
                                <p class="text-xs text-gray-500 mt-1">يجب أن تحتوي على الأقل على 8 أحرف، حرف واحد ورقم واحد على الأقل</p>
                            </div>
                            ...
                            <div>
                                ...
                                <select id="role" name="role" class="form-input w-full px-4 py-2 rounded-lg" required>
                                    <option value="employee" <?= (isset($_SESSION['old_input']['role']) && $_SESSION['old_input']['role'] == 'employee') ? 'selected' : '' ?>>موظف</option>
                                    <option value="manager" <?= (isset($_SESSION['old_input']['role']) && $_SESSION['old_input']['role'] == 'manager') ? 'selected' : '' ?>>مدير</option>
                                </select>
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <select id="department" name="department" class="form-input w-full px-4 py-2 rounded-lg" required>
                                    <option value="الموارد البشرية" <?= (isset($_SESSION['old_input']['department']) && $_SESSION['old_input']['department'] == 'الموارد البشرية') ? 'selected' : '' ?>>الموارد البشرية</option>
                                    <option value="المشاريع" <?= (isset($_SESSION['old_input']['department']) && $_SESSION['old_input']['department'] == 'المشاريع') ? 'selected' : '' ?>>المشاريع</option>
                                    <option value="المالية" <?= (isset($_SESSION['old_input']['department']) && $_SESSION['old_input']['department'] == 'المالية') ? 'selected' : '' ?>>المالية</option>
                                    <option value="developer" <?= (isset($_SESSION['old_input']['department']) && $_SESSION['old_input']['department'] == 'developer') ? 'selected' : '' ?>>Developer</option>
                                </select>
                            ...
                            <div>
                                ...
                                <input type="text" id="position" name="position" value="<?= isset($_SESSION['old_input']['position']) ? htmlspecialchars($_SESSION['old_input']['position']) : '' ?>" 
                                    class="form-input w-full px-4 py-2 rounded-lg" required
                                    pattern="[\\u0600-\\u06FF\\u0750-\\u077F\\u08A0-\\u08FF\\s]{2,50}" 
                            ...
                            <div>
                                ...
                                <input type="date" id="hire_date" name="hire_date" value="<?= isset($_SESSION['old_input']['hire_date']) ? htmlspecialchars($_SESSION['old_input']['hire_date']) : '' ?>" 
                                    class="form-input w-full px-4 py-2 rounded-lg" required
                                    max="<?= date('Y-m-d') ?>">
                            ...
                            <div>
                                ...
                                <input type="number" step="0.01" id="salary" name="salary" value="<?= isset($_SESSION['old_input']['salary']) ? htmlspecialchars($_SESSION['old_input']['salary']) : '' ?>" 
                                    class="form-input w-full px-4 py-2 rounded-lg" required
                                    min="0" 
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <input type="tel" id="phone" name="phone" value="<?= isset($_SESSION['old_input']['phone']) ? htmlspecialchars($_SESSION['old_input']['phone']) : '' ?>" 
                            ...
                            <div>
                                ...
                                <textarea id="address" name="address" rows="3" class="form-input w-full px-4 py-2 rounded-lg"><?= isset($_SESSION['old_input']['address']) ? htmlspecialchars($_SESSION['old_input']['address']) : '' ?></textarea>
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <select id="work_type" name="work_type" class="form-input w-full px-4 py-2 rounded-lg">
                                    <option value="full-time" <?= (isset($_SESSION['old_input']['work_type']) && $_SESSION['old_input']['work_type'] == 'full-time') ? 'selected' : '' ?>>دوام كامل</option>
                                    <option value="part-time" <?= (isset($_SESSION['old_input']['work_type']) && $_SESSION['old_input']['work_type'] == 'part-time') ? 'selected' : '' ?>>دوام جزئي</option>
                                    <option value="freelance" <?= (isset($_SESSION['old_input']['work_type']) && $_SESSION['old_input']['work_type'] == 'freelance') ? 'selected' : '' ?>>عمل حر</option>
                                </select>
                            ...
                            <div>
                                ...
                                <input type="number" id="leaveBalance" name="leaveBalance" value="<?= isset($_SESSION['old_input']['leaveBalance']) ? htmlspecialchars($_SESSION['old_input']['leaveBalance']) : '0' ?>" 
                                    class="form-input w-full px-4 py-2 rounded-lg" required
                                    min="0" max="60" 
    ...
    <script>
        ...
        //     });
            ...
            // تعيين القيمة الافتراضية لحقل تاريخ التعيين إذا كان فارغاً
