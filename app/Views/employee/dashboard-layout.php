...
<body class="flex h-screen text-gray-800">
    ...
    <aside class="sidebar w-64 bg-gradient-to-b from-blue-800 to-blue-900 shadow-xl flex flex-col">
        ...
        <nav class="flex-1 p-4 mt-4">
            <a href="/employee-portal/public/employee" class="flex items-center sidebar-item p-3 mb-3 rounded-lg text-white hover:bg-blue-700 hover:shadow-md">
                <span class="material-icons mr-3">home</span> 
                <span>الرئيسية</span>
            </a>
            
            <a href="/employee-portal/public/employee/profile" class="flex items-center sidebar-item p-3 mb-3 rounded-lg text-white hover:bg-blue-700 hover:shadow-md">
                <span class="material-icons mr-3">person</span> 
                <span>الملف الشخصي</span>
            </a>
            
            <a href="/employee-portal/public/employee/tasks" class="flex items-center sidebar-item p-3 mb-3 rounded-lg text-white hover:bg-blue-700 hover:shadow-md">
                <span class="material-icons mr-3">task</span> 
                <span>مهامي</span>
           
            </a>

            <a href="/employee-portal/public/employee/leave-request" class="flex items-center sidebar-item p-3 mb-3 rounded-lg text-white hover:bg-blue-700 hover:shadow-md">
                <span class="material-icons mr-3">event_available</span> 
                <span>طلب إجازة</span>
            </a>
            
            <a href="/employee-portal/public/employee/leaves" class="flex items-center sidebar-item p-3 mb-3 rounded-lg text-white hover:bg-blue-700 hover:shadow-md">
            ...
            <a href="/employee-portal/public/employee/salaries" class="flex items-center sidebar-item p-3 mb-3 rounded-lg text-white hover:bg-blue-700 hover:shadow-md">
        ...
        <div class="p-6">
            ...
            <div class="bg-white rounded-xl shadow-md p-6">
                ...
                <div class="text-center py-12">
                    ...
                    <h2 class="text-2xl font-bold text-gray-700 mb-2">مرحبًا في لوحة تحكم الموظف</h2>
                    <p class="text-gray-500">اختر قسمًا من القائمة الجانبية لبدء عملك</p>
                </div>
                ' ?>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-md p-6 mb-8 mt-8">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
                     <a href="/employee-portal/public/employee/salaries" class="flex flex-col items-center justify-center p-4 bg-blue-50 rounded-lg hover:bg-blue-100 transition-colors">
                        <span class="material-icons text-blue-600 text-3xl mb-2">money</span>
                        <span class="text-blue-800 font-medium"> مراجعة الرواتب</span>
                    </a>
                    <a href="/employee-portal/public/employee/leaves" class="flex flex-col items-center justify-center p-4 bg-green-50 rounded-lg hover:bg-green-100 transition-colors">
                    ...
                    <a href="/employee-portal/public/employee/tasks" class="flex flex-col items-center justify-center p-4 bg-purple-50 rounded-lg hover:bg-purple-100 transition-colors">
                        <span class="material-icons text-purple-600 text-3xl mb-2">assignment</span>
                        <span class="text-purple-800 font-medium"> المهام</span>
                    </a>
                    <a href="/employee-portal/public/employee/leave-request" class="flex flex-col items-center justify-center p-4 bg-orange-50 rounded-lg hover:bg-orange-100 transition-colors">
