<div class="bg-white p-6 rounded-lg shadow-md">
    <h2 class="text-2xl font-bold mb-6">الرواتب التي وافقت عليها</h2>
        ...
        <table class="min-w-full bg-white">
            <thead>
                <tr>
                    ...
                    <th class="px-4 py-2 border">التعليقات</th>
            ...
            <tbody>
                <?php if (!empty($salaries)): ?>
                    <?php foreach ($salaries as $index => $salary): ?>
                        ...
                        <tr>
                            ...
                            <td class="px-4 py-2 border"><?= $salary['updated_at'] ?></td>
                            <td class="px-4 py-2 border"><?= htmlspecialchars($salary['comments'] ?? 'لا توجد تعليقات') ?></td>
                ...
                <?php else: ?>
                    <tr>
                        <td colspan="10" class="px-4 py-2 border text-center">لم توافق على أي رواتب حتى الآن</td>
                    </tr>
                <?php endif; ?>
            </tbody>
        </table>
